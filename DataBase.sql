...
INSERT INTO `equipos` VALUES (1,'River Plate',1),(13,'Rosario Central',1),(14,'Newell\'s',1),(15,'Boca Juniors',1),(16,'Gimnasia',1),(17,'Aldosivi',1),(18,'Belgrano',1),(19,'Lanus',1),(20,'Independiente',1),(21,'Defensa y Justicia',1),(22,'Huracan',1),(23,'Argentinos Jrs',1),(24,'San Martin de Tucuman',1),(25,'Godoy Cruz',1),(26,'San Martin',1),(27,'Velez',1),(28,'Patronato',1);
...
INSERT INTO `ligas` VALUES (1,'Superliga Argentina',NULL),(2,'Copa Argentina',NULL);
...
CREATE TABLE `partidos` (
  ...
  `GOL_LOCAL` int(11) DEFAULT '0',
  `GOL_VISITANTE` int(11) DEFAULT '0',
  `LIGA` int(11) DEFAULT NULL,
...
INSERT INTO `partidos` VALUES ('2018-09-23',NULL,15,1,0,2,1),('2018-09-23',NULL,16,13,1,1,1),('2018-09-24',NULL,17,18,2,0,1),('2018-09-28',NULL,19,1,0,0,1),('2018-10-06',NULL,17,24,0,0,1);
...
INSERT INTO `usuarios` VALUES ('GABRIEL','123','USR',1,'ISLENO.GABRIEL@GMAIL.COM'),('admin','admin','ADMIN',6,'admin@admin.com'),('gabomastr','rosario12','USR',12,'gabomastr@yahoo.com');
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `partidos_hoy` AS select date_format(`p`.`FECHA`,'%d/%m/%Y') AS `FECHA`,`e`.`NOMBRE` AS `LOCAL`,`p`.`GOL_LOCAL` AS `L`,`e2`.`NOMBRE` AS `VISITANTE`,`p`.`GOL_VISITANTE` AS `V`,`l`.`NOMBRE` AS `LIGA` from (((`partidos` `p` join `equipos` `e` on((`p`.`LOCAL` = `e`.`ID`))) join `equipos` `e2` on((`p`.`VISITANTE` = `e2`.`ID`))) join `ligas` `l` on((`p`.`LIGA` = `l`.`ID`))) where (`p`.`FECHA` = curdate()) order by date_format(`p`.`FECHA`,'%d/%m/%Y') desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `partidos_todos` AS select date_format(`p`.`FECHA`,'%d/%m/%Y') AS `FECHA`,`e`.`NOMBRE` AS `LOCAL`,`p`.`GOL_LOCAL` AS `L`,`e2`.`NOMBRE` AS `VISITANTE`,`p`.`GOL_VISITANTE` AS `V`,`l`.`NOMBRE` AS `LIGA` from (((`partidos` `p` join `equipos` `e` on((`p`.`LOCAL` = `e`.`ID`))) join `equipos` `e2` on((`p`.`VISITANTE` = `e2`.`ID`))) join `ligas` `l` on((`p`.`LIGA` = `l`.`ID`))) order by date_format(`p`.`FECHA`,'%d/%m/%Y') desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2018-10-06 18:19:46
